...
function parsePath(path) {
  ...
  const dirs = parsed.dir.split(Path.sep); // if path is "/foo/bar/baz.html.njk":
...
class NunjucksAsset extends Asset {
  ...
  async load() {
    ...
    const env = force(config.env, parsedPath) || Nunjucks.configure(templateDirs, config.options || {});
